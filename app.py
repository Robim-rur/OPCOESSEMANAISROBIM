...
st.write("O app analisa bancos, energia, saneamento, petróleo e celulose e mostra as 5 melhores operações da semana.")

# Lista de ativos
ativos = [
"BBAS3.SA","ITUB4.SA","BBDC4.SA","SANB11.SA","BPAC11.SA",
"ELET3.SA","EGIE3.SA","TAEE11.SA","CPFE3.SA","TRPL4.SA",
"CMIG4.SA","CPLE6.SA","NEOE3.SA","ENGI11.SA",
    ...
    for ativo in ativos:
        try:
            ...
            for exp in expiracoes:
                ...
                if dias <= 0 or dias > 30:  # até 30 dias
                    continue
...
if st.button("ANALISAR MELHORES OPÇÕES DA SEMANA"):
    with st.spinner("Analisando mercado..."):
        tabela = analisar()
    if len(tabela)==0:
        st.warning("Nenhuma opção encontrada. Isso pode acontecer se o Yahoo Finance não listar as opções brasileiras dessa semana.")
    else:
